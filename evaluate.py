...
if __name__ == '__main__':
    ...
    if whole_data is not False:
        ...
        print("macro_F1:\t{:.2f}\t\tmacro_P:\t{:.2f}\t\tmacro_R:\t{:.2f}\t\t".format(scores['macro_F1'], scores['macro_P'], scores['macro_R']) +
              "SUBJ_F1:\t{:.2f}\t\tSUBJ_P:\t{:.2f}\t\tSUBJ_R:\t{:.2f}\t\t".format(scores['SUBJ_F1'], scores['SUBJ_P'], scores['SUBJ_R']) +
              "accuracy:\t{}".format(scores['accuracy']))
